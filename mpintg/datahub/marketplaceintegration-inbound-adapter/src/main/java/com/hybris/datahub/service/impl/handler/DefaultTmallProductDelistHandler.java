 ...
 * 
 */
public class DefaultTmallProductDelistHandler implements MarketplaceIntegrationHandler
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTmallProductDelistHandler.class);
	...
	{
		LOG.debug("Product Delisting: " + context);
