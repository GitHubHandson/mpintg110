 ...
 * 
 */
public class DefaultTmallProductListHandler implements MarketplaceIntegrationHandler
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTmallProductListHandler.class);
	...
	{
		LOG.debug("Product Listing: " + context);
