 ...
 *  
 */
package de.hybris.platform.marketplaceintegrationinitialdata.jalo;
...
/**
 * This is the extension manager of the Marketplaceintegrationinitialdata extension.
 */
public class MarketplaceintegrationinitialdataManager extends GeneratedMarketplaceintegrationinitialdataManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MarketplaceintegrationinitialdataManager.class.getName());
	 ...
	 */
	public static MarketplaceintegrationinitialdataManager getInstance()
	{
		return (MarketplaceintegrationinitialdataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MarketplaceintegrationinitialdataConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MarketplaceintegrationinitialdataManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MarketplaceintegrationinitialdataManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MarketplaceintegrationinitialdataManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MarketplaceintegrationinitialdataManager called, current tenant: " + getTenant().getTenantID());
		}
	}
