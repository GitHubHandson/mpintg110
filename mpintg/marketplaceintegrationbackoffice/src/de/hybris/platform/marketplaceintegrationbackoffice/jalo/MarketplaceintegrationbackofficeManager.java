 ...
 *  
 */
package de.hybris.platform.marketplaceintegrationbackoffice.jalo;
...
import de.hybris.platform.marketplaceintegrationbackoffice.constants.MarketplaceintegrationbackofficeConstants;
 ...
 */
public class MarketplaceintegrationbackofficeManager extends GeneratedMarketplaceintegrationbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MarketplaceintegrationbackofficeManager.class.getName());
	 ...
	 */
	public static MarketplaceintegrationbackofficeManager getInstance()
	{
		return (MarketplaceintegrationbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MarketplaceintegrationbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MarketplaceintegrationbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MarketplaceintegrationbackofficeManager called.");
		}
	}
