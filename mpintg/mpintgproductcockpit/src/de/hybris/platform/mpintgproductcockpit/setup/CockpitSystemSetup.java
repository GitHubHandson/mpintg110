 ...
 *  
 */
package de.hybris.platform.mpintgproductcockpit.setup;
...
import de.hybris.platform.mpintgproductcockpit.constants.MpintgproductcockpitConstants;
 ...
 */
@SystemSetup(extension = MpintgproductcockpitConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MpintgproductcockpitConstants.JASPER_REPORTS_MEDIA_FOLDER)
					.size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MpintgproductcockpitConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MpintgproductcockpitConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null)
				{
					importImpexFile(context, "/accCockpit/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
