 ...
 *  
 */
package de.hybris.platform.mpintgproductcockpit.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("accCockpit.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("accCockpit.product.externalTaxes"));
