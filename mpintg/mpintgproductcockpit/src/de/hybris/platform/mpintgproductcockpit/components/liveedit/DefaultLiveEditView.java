 ...
 *  
 */
package de.hybris.platform.mpintgproductcockpit.components.liveedit;
...
import de.hybris.platform.mpintgproductcockpit.cmscockpit.session.impl.DefaultLiveEditBrowserArea;
...
public class DefaultLiveEditView extends LiveEditView<DefaultLiveEditPopupEditDialog>
{
	...
	protected DefaultLiveEditPopupEditDialog createLiveEditPopupDialog(final Map<String, Object> passedAttributes)
	...
	{
		if (!(reason instanceof DefaultLiveEditPopupEditDialog) && this.getPopupEditorDialog() != null
				&& this.getPopupEditorDialog().isVisible() && !this.getPopupEditorDialog().equals(reason))
		{
