 ...
 *  
 */
package de.hybris.platform.mpintgordermanagement.actions.order.cancel;
...
import de.hybris.platform.mpintgordermanagement.actions.consignment.VerifyConsignmentCompletionAction;
...
public class VerifyOrderPostCancellationAction extends AbstractAction<OrderProcessModel>
{
	...
	public String execute(final OrderProcessModel orderProcessModel) throws Exception
	{
		...
		else if (orderProcessModel.getOrder().getConsignments().stream()
				.anyMatch(consignment -> !consignment.getStatus().equals(ConsignmentStatus.CANCELLED)))
		{
