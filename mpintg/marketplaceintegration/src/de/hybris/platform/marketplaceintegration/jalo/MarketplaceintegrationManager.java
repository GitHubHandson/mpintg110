...
/**
 * This is the extension manager of the Marketplaceintegration extension.
 */
public class MarketplaceintegrationManager extends GeneratedMarketplaceintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MarketplaceintegrationManager.class.getName());
	 ...
	 */
	public static MarketplaceintegrationManager getInstance()
	{
		return (MarketplaceintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MarketplaceintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MarketplaceintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MarketplaceintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MarketplaceintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MarketplaceintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
