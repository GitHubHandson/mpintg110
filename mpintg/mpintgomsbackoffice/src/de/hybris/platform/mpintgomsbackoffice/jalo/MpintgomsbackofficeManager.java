 ...
 *  
 */
package de.hybris.platform.mpintgomsbackoffice.jalo;
...
import de.hybris.platform.mpintgomsbackoffice.constants.MpintgomsbackofficeConstants;
 ...
 */
public class MpintgomsbackofficeManager extends GeneratedMpintgomsbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MpintgomsbackofficeManager.class.getName());
	 ...
	 */
	public static MpintgomsbackofficeManager getInstance()
	{
		return (MpintgomsbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MpintgomsbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MpintgomsbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MpintgomsbackofficeManager called.");
		}
	}
