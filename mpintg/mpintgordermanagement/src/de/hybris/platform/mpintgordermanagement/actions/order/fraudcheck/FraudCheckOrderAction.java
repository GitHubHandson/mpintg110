 ...
 *  
 */
package de.hybris.platform.mpintgordermanagement.actions.order.fraudcheck;
...
public class FraudCheckOrderAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	{
		final String value = Config.getParameter(MpintgordermanagementConstants.EXTENSIONNAME + ".fraud." + property);
