 ...
 *  
 */
package de.hybris.platform.mpintgordermanagement.actions.order.payment;
...
import de.hybris.platform.mpintgordermanagement.actions.order.payment.SendPaymentFailedNotificationAction;
...
public class SendPaymentFailedNotificationActionTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.platform.mpintgordermanagement.actions.order.SendPaymentFailedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
