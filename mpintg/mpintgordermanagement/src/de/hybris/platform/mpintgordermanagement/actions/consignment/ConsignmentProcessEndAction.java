 ...
 *  
 */
package de.hybris.platform.mpintgordermanagement.actions.consignment;
...
public class ConsignmentProcessEndAction extends AbstractProceduralAction<ConsignmentProcessModel>
{
	...
	public void executeAction(final ConsignmentProcessModel process)
	{
		...
		final String eventId = process.getParentProcess().getCode() + "_" + MpintgordermanagementConstants.ORDER_ACTION_EVENT_NAME;
		...
		LOG.debug("Process: " + process.getCode() + " fired event " + MpintgordermanagementConstants.ORDER_ACTION_EVENT_NAME);
	}
}
